...
LABEL org.opencontainers.image.title="EAI Class Image"
LABEL org.opencontainers.image.description="This image contains \
all the packages required for EAI class programs preinstalled."
LABEL org.opencontainers.image.source="https://github.com/kbdharun/EA-pgms"
